      ...
      <div className="bg-white px-4 py-5 border-b border-gray-200 sm:px-6">
        <div className="-ml-4 -mt-4 flex justify-between items-center flex-wrap sm:flex-no-wrap">
          <div className="ml-4 mt-4">
            <h3 className="text-lg leading-6 font-medium text-gray-900">{course.code}</h3>
            <p className="mt-1 text-sm leading-5 text-gray-500">{course.name}</p>
          </div>
              ...
              <div className="px-4 py-4 sm:px-6">
                <div className="flex items-center justify-between">
                  <div className="text-sm leading-5 font-medium text-cse-600 truncate">
                    <span
                      className={`inline-flex items-center px-2.5 py-0.5 w-12 justify-center mr-2 rounded-md text-sm font-medium leading-5 ${
                        assignment.workloadType.name === "PA"
