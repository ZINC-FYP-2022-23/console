...
function GenerateExpectedOutputStepsToComplete() {
  ...
  return (
    <div className="ml-16 mt-3 space-y-3 text-sm text-gray-700">
      ...
      <div className="flex gap-3">
        {settingsUseGenerated ? tickIcon : crossIcon}
        <div>
          <p>
            Enable &quot;
            <button
          ...
          {!settingsUseGenerated && (
            <Button
              ...
              icon={<FontAwesomeIcon icon={["fas", "toggle-on"]} />}
              className="mt-2 border border-cse-600 text-sm hover:bg-blue-100 active:bg-blue-200"
            >
              Click me to enable
            </Button>
          )}
