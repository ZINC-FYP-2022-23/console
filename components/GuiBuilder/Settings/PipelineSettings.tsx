    ...
    <div className="px-1 flex flex-col gap-8 text-sm">
      ...
      <div>
        ...
        <div className="flex flex-col gap-5">
          ...
          />
          <div id={highlightableElementIds.useGeneratedWrapper} className="flex items-center gap-2">
            <SwitchGroup
              label="Allow access to files generated by the Grader"
              checked={_settings.use_generated}
              onChange={(value) => {
                updateSettings((_settings) => (_settings.use_generated = value));
              }}
            />
            <UseGeneratedTooltip />
          </div>
...
const UseGeneratedTooltip = memo(() => (
  <InfoTooltip width={520}>
    <ul className="px-3 list-disc">
      <li>Some pipeline stages may generate new files during execution.</li>
      <li>
        e.g. The Standard I/O Test stage has an experimental feature that generates expected output of test cases.
      </li>
      <li>For security, only enable this option if a pipeline stage needs to access generated files.</li>
    </ul>
  </InfoTooltip>
));
UseGeneratedTooltip.displayName = "UseGeneratedTooltip";
