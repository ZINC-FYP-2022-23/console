        ...
        <div className="px-4 py-4 flex items-center sm:px-6">
          ...
          <div className="ml-5 flex-shrink-0">
            <button className="focus:outline-none" onClick={() => setCollapsed(!showCollapsedContent)}>
              <FontAwesomeIcon
                className="h-5 w-5 text-gray-400 transition duration-150 ease-in-out"
                icon={["far", "chevron-right"]}
                size="1x"
                {...(showCollapsedContent && { rotation: 90 })}
              />
            </button>
          </div>
        </div>
  ...
  return (
    <div className="h-full flex flex-col bg-cool-gray-50 shadow-xl overflow-y-scroll">
      ...
      <div className="relative flex-1 py-6 px-4 sm:px-6">
        <h3 className="mb-2 text-lg leading-6 font-medium text-gray-900">Roles and Permissions</h3>
