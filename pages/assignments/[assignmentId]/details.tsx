  ...
  const validateInputs = () => {
    if (assignment.name.length > 0 && assignment.description_html.length > 0) {
      ...
      dispatch({
        ...
        payload: {
          success: false,
          title: "Missing Input fields detected",
          message: "Please make sure all the necessary information is present before submitting",
        },
      });
      return false;
    }
        ...
        if (validateInputs()) {
          ...
          dispatch({
            ...
            payload: {
              ...
              message: "Your changes to the assignment details has been saved",
            },
          });
        }
      }}
      ...
      <div className="px-4 py-5 bg-white sm:p-6">
        <div className="grid grid-cols-6 gap-6">
          <div className="col-span-6 sm:col-span-3">
            <label htmlFor="assignmentName" className="block text-sm font-medium leading-5 text-gray-700">
              Name
            </label>
            <input
              id="assignmentName"
          ...
          <div className="col-span-6 sm:col-span-3">
            <label htmlFor="assignmentType" className="block text-sm font-medium leading-5 text-gray-700">
              Type
            </label>
            <select
          ...
          <div className="pb-5 border-b border-gray-200">
            <div className="pb-5 border-b border-gray-200 space-y-3 sm:flex sm:items-center sm:justify-between sm:space-x-4 sm:space-y-0">
              <div className="-mt-2 flex flex-wrap items-baseline">
                <h3 className="text-lg leading-6 font-medium text-gray-900">{data.assignment.name}</h3>
