    ...
    <div className="h-full flex flex-col bg-cool-gray-50 shadow-xl overflow-y-scroll">
      <header className="space-y-1 py-6 px-4 bg-cse-600 sm:px-6">
        <div className="flex items-center justify-between space-x-3">
          <h2 className="text-lg leading-7 font-medium text-white">User Information</h2>
      ...
      <div className="relative flex-1 py-6 px-4 sm:px-6">
        <h3 className="mb-2 text-lg leading-6 font-medium text-gray-900">Courses</h3>
            ...
            <div className="shadow overflow-hidden sm:rounded-md">
              <div className="px-4 py-5 bg-white sm:p-6">
                <fieldset>
                  ...
                  <div className="mt-4">
                    <div className="mt-4">
                      <label htmlFor="account_number" className="block text-sm font-medium leading-5 text-gray-700">
                        Maximum number of submssion allowed
                      </label>
                    ...
                    <ul className="border border-gray-200 rounded-md">
                      <li className="pl-3 pr-4 py-3 flex items-center justify-between text-sm leading-5">
                        <div className="w-0 flex-1 flex items-center">
                          ...
                          <span className="ml-2 flex-1 w-0 truncate">Release Assignment on</span>
                        </div>
                        <div className="ml-4 flex-shrink-0">
                          <button
                            onClick={() => dispatch({ type: "toggleSlideOver", payload: {} })}
                            type="button"
                            className="font-medium text-cse-600 hover:text-cse-500 transition duration-150 ease-in-out"
                          >
                            Change
                          </button>
                        </div>
                      ...
                      <li className="border-t border-gray-200 pl-3 pr-4 py-3 flex items-center justify-between text-sm leading-5">
                        <div className="w-0 flex-1 flex items-center">
                          ...
                          <span className="ml-2 flex-1 w-0 truncate">Start Collecting on</span>
                        </div>
                        <div className="ml-4 flex-shrink-0">
                          <button
                            onClick={() => dispatch({ type: "toggleSlideOver", payload: {} })}
                      ...
                      <li className="border-t border-gray-200 pl-3 pr-4 py-3 flex items-center justify-between text-sm leading-5">
                        <div className="w-0 flex-1 flex items-center">
                          ...
                          <span className="ml-2 flex-1 w-0 truncate">Assignment Due on</span>
                        </div>
                        <div className="ml-4 flex-shrink-0">
                          <button
                            onClick={() => dispatch({ type: "toggleSlideOver", payload: {} })}
                      ...
                      <li className="border-t border-gray-200 pl-3 pr-4 py-3 flex items-center justify-between text-sm leading-5">
                        <div className="w-0 flex-1 flex items-center">
                          ...
                          <span className="ml-2 flex-1 w-0 truncate">Stop Collecting on</span>
                        </div>
                        <div className="ml-4 flex-shrink-0">
                          <button
                            onClick={() => dispatch({ type: "toggleSlideOver", payload: {} })}
                ...
                <fieldset className="mt-6">
                  ...
                  <p className="text-sm leading-5 text-gray-500">
                    These are delivered via Email to students ITSC mailbox.
                  </p>
                  <div className="mt-4">
                    ...
                    <div className="mt-4 flex items-center">
                      ...
                      <label htmlFor="push_email" className="ml-3">
                        <span className="block text-sm leading-5 font-medium text-gray-700">
                          For failed grading and grade releases
                        </span>
                      </label>
                    </div>
                    <div className="mt-4 flex items-center">
                    ...
                    <div className="shadow sm:rounded-md sm:overflow-hidden">
                      <div className="px-4 py-5 bg-white sm:p-6">
                        ...
                        <div className="mt-6">
                          ...
                          <p className="mt-2 text-sm text-gray-500">Brief description for the assignment.</p>
                        </div>
                      </div>
                      <div className="px-4 py-3 bg-gray-50 text-right sm:px-6">
                        <span className="inline-flex rounded-md shadow-sm">
                          <button
                            type="submit"
                            className="inline-flex justify-center py-2 px-4 border border-transparent text-sm leading-5 font-medium rounded-md text-white bg-cse-600 hover:bg-cse-500 focus:outline-none focus:border-cse-700 focus:shadow-outline-cse active:bg-cse-700 transition duration-150 ease-in-out"
                          >
                            Save
                          </button>
                        </span>
